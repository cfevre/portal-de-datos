 ...
 */
class Documento extends \Entities\Documento implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'titulo', 'descripcion', 'url', 'mime', 'size', 'created_at', 'updated_at', 'dataset');
    }
