<div class="page-header">
  <h1>Visualizaciones<small></small></h1>
</div>
<form action="<?php echo site_url('backend/visualizacion'); ?>" class="form-filtros form-inline">
...
<h3>Selecciona las visualizaciones a mostrar</h3>
<hr>
<?php echo $pagination; ?>
